...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 150px">
        ...
        <div class="d-inline-flex">
            ...
            <p class="m-0 px-2">-</p>
            <p class="m-0"><?php echo $cat_name ?></p>
        </div>
    </div>
</div>
<!-- Page Header End -->
    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-9 col-md-12">
            <div class="row pb-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="dropdown ml-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                <a class="dropdown-item" href="?sortby=latest">Latest</a>
                ...
                if ($search != "") {
                    $productQuery = "SELECT * FROM products WHERE name LIKE '%$search%'";
                }
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4" style="height:500px;">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../back_end/uploads/<?php echo $product['image'] ?>" alt="" style="height:500px;">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3"><?php echo $product['name'] ?></h6>
                                <div class="d-flex justify-content-center">
                                    <h6><?php echo  $product['price1'] ?></h6>
                                    <h6 class="text-muted ml-2"><del><?php echo  $product['price2'] ?></del></h6>
                                </div>
                            </div>
